package zjyun.spring_aop.AOP的应用.日志记录.aspect;
...
public class MyLogAspect {
    ...
    @Pointcut("execution(void zjyun.spring_aop.AOP的应用.日志记录.MyServiceImpl.fun1())")
    public void pointcut1(){}

    @Pointcut("execution(void zjyun.spring_aop.AOP的应用.日志记录.MyServiceImpl.fun2())")
