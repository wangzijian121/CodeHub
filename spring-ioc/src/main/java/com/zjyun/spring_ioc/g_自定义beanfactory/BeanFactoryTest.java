...
public class BeanFactoryTest {
    public static void main(String[] args) {
        ...
        //这里构造出的Bean单例由于没有bean注解的支持，解析不到bean2
        //还会导致53行的 getBean(Bean1.class).getBean2()获取不到bean2，需要注释掉
        beanFactory.getBeansOfType(Bean1.class).values().forEach(x -> System.out.println("使用bean后置处理器之前的Bean1实例🧐：" + x));//Bean1(bean2=null, beanName=null)
